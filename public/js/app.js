...
var UsersList = React.createClass({
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				'h3',
			{ className: 'btn btn-rd btn-wire btn-sm navbar-nav-li-a wire-btn-cerulean-blue contactme' },
				' Online Users '
			),
			React.createElement(
				'ul',
			{ className: 'mg-lg fadeInLeft animDelay06  tc-battleship-grey animated' },
...
var Message = React.createClass({
	displayName: 'bloc bgc-anti-flash-white l-bloc',

	render: function render() {
		return React.createElement(
			'div',
			{ className: 'bloc bgc-anti-flash-white l-bloc' },
			React.createElement(
				'strong',
				{ className: 'mg-md  mb50 tc-cerulean-blue text-center' },
				this.props.user,
				':'
			),
			React.createElement(
